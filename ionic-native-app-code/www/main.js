(self["webpackChunkphoto_app"] = self["webpackChunkphoto_app"] || []).push([["main"],{
...
/* harmony import */ var _services_pictures_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/pictures.service */ 7180);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        ...
        providers: [
            ...
            _services_pictures_service__WEBPACK_IMPORTED_MODULE_3__.PicturesService,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PicturesService": () => (/* binding */ PicturesService)
/* harmony export */ });
...
let PicturesService = class PicturesService {
     ...
     * @return {Promise}
     */
    selectImageWithCamera(imageWidth, imageHeight) {
        return new Promise((resolve, reject) => {
            const imageDimensions = this.calculateImageAspectRatio(imageWidth, imageHeight, this.MAX_WIDTH, this.MAX_HEIGHT);
     ...
     * @return {Promise}
     */
    selectImageFromLibrary(imageWidth, imageHeight) {
        return new Promise((resolve, reject) => {
            const imageDimensions = this.calculateImageAspectRatio(imageWidth, imageHeight, this.MAX_WIDTH, this.MAX_HEIGHT);
     ...
     * @return {Promise}
     */
    selectImageFromSavedPhotoAlbum(imageWidth, imageHeight) {
        return new Promise((resolve, reject) => {
            const imageDimensions = this.calculateImageAspectRatio(imageWidth, imageHeight, this.MAX_WIDTH, this.MAX_HEIGHT);
            // Define image options
            const imageOptions = {
     ...
     * @return {any}
     */
    calculateImageAspectRatio(sourceWidth, sourceHeight, maxWidth, maxHeight) {
        const minVal1 = maxWidth / sourceWidth;
        const minVal2 = maxHeight / sourceHeight;
        const ratio = Math.min(minVal1, minVal2);
...
PicturesService.ctorParameters = () => [
    { type: _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_0__.Camera }
];
PicturesService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
